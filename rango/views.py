...
def add_category(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            print("Added category: ", cat, ' | slug: ', cat.slug)
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            if category:
                ...
                page.views = 0
                page.save()
                print('Page added: ', page.title, ' | cat: ', page.category,
                      ' | url: ', page.url)
...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            # Once hashed, we cnan update the user object.
...
def user_login(request):
    ...
    if request.method == 'POST':
        ...
        # request.POST.get('<variables>') returns None if the
        ...
        if user:
            ...
            context_dict['error'] = "Invalid login details supplied. Check again and re-try:"
